...
stop_time = datetime.datetime(year, mon, day, 18, 55, 0)
...
while dt < stop_time:
    ...
    cmd = "prep_grid3d.py -d %s -w -o %s --realtime %s -p 6" % (_MRMS_input_directory, obs_seq_out_dir, dt.strftime("%Y%m%d%H%M"))
